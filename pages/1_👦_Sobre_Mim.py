...
with col1:
    ...
    st.markdown('<div style="font-size: 14px">Mas não se preocupe, meu amigo, sou fluente em SQL, o que significa que posso falar a língua das bases de dados como ninguém!</div>', unsafe_allow_html=True)
