...
with col1:
    ...
    st.markdown("Tenho 14+ anos de experiência na solução de problemas de negócios utilizando como ferramentas o ERP Totvs Protheus nas áreas de Faturamento, Produção, Estoque, Financeiro, Gestão de Contratos e de Serviços, SQL e mais recentemente, Machine Learning.")
